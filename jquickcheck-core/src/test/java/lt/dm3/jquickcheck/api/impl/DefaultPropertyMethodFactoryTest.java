...
public class DefaultPropertyMethodFactoryTest {
    ...
    private PropertyMethodFactory<Generator<?>> factory = new DefaultPropertyMethodFactory<Generator<?>>(
                                                     new DefaultInvocationSettings(Annotations.newInstance(QuickCheck.class)));
    ...
    public void shouldCreatePropertyMethodFromANoArgumentsMethod() throws SecurityException, NoSuchMethodException {
        ...
        PropertyInvocation<Generator<?>> i = m.createInvocationWith(new TestRepo(Collections.<GeneratorHolder> emptyList()));
    ...
    @Test
    public void shouldCreatePropertyMethodFromANoArgumentsMethodWithAnnotation() throws SecurityException, NoSuchMethodException {
